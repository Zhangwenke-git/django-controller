    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expect', models.JSONField(null=True, verbose_name='结果解析表达式')),
                ...
                ('sql', models.CharField(blank=True, max_length=1024, null=True, verbose_name='校验SQL')),
                ('dbinfo', models.CharField(blank=True, max_length=128, null=True, verbose_name='数据库信息')),
            ],
            options={
